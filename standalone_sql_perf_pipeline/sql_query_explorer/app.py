...
with col_side:
    ...
    st.markdown(
        ...
        <div class="schema-image-box">
            ...
            <div class="label">Image can be put into image boxes</div>
            <div>Upload or paste a schema diagram here.<br>
            Replace this placeholder with an <code>st.image()</code> call
            pointing to your ERD / schema PNG.</div>
        </div>
        """,
        unsafe_allow_html=True,
    )
